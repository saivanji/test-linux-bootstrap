...
call <sid>hi('Todo',                       s:base0A, s:none,   '',          '')
...
call <sid>hi('xmlTagName',                 s:base08, '',       '',          '')
call <sid>hi('xmlEndTag',                  s:base0C, '',       '',          '')
call <sid>hi('xmlAttrib',                  s:base0E, '',       '',          '')

" TODO: consider not defining javascript here at a first place but use default
" syntax first
""" Javascript

" Modules
call <sid>hi('jsImport',                   s:base0C, '',       '',          '')
call <sid>hi('jsFrom',                     s:base0C, '',       '',          '')
call <sid>hi('jsModuleAs',                 s:base0C, '',       '',          '')
call <sid>hi('jsExport',                   s:base0C, '',       '',          '')
call <sid>hi('jsExportDefault',            s:base0E, '',       '',          '')

" Program Keywords
call <sid>hi('jsStorageClass',             s:base0E, '',       '',          '')
call <sid>hi('jsFunction',                 s:base0E, '',       '',          '')
call <sid>hi('jsReturn',                   s:base0E, '',       '',          '')
" call <sid>hi('jsSwitchCase',               s:base0E, '',       '',          '')
...
call <sid>hi('jsFuncArgCommas',            s:base0C, '',       '',          '')
